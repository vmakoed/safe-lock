...
func _ready() -> void:
	var up_button = controls.get_node("UpButton")
	var left_button = controls.get_node("LeftButton")
	var right_button = controls.get_node("RightButton")
	var down_button = controls.get_node("DownButton")
	var confirm_button = controls.get_node("ConfirmButton")
	var delete_button = controls.get_node("DeleteButton")
